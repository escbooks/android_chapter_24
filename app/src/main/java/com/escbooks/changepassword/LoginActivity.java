...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setDrawer() {
        ...
        findViewById(R.id.drawer_settings_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(LoginActivity.this, "Settings Click", Toast.LENGTH_SHORT).show();
